...
describe 'Profile resource', type: :request, autodoc: true do
  ...
  describe "PATCH /api/v1/profile" do
    context_user_authenticated do
      ...
      context 'when params display_name and display_id and apply_default_icon true' do
        let!(:params) { { display_name: 'ほげ', display_id: 'hoge', apply_default_icon: 1 } }
      ...
      context 'when params display_name and display_id and apply_default_icon false' do
        let!(:params) { { display_name: 'ほげ', display_id: 'hoge', apply_default_icon: 0 } }
